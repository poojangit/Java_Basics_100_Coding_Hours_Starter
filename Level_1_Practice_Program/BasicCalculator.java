...
public class BasicCalculator {
    public static void main(String[] args) {
        ...
        System.out.println("The addition, substaction, and multiplication and division value of 2 numbers " + num1 + " and "+ num2 + " is " + addition+ ","+ subtraction + "," + multiplication + " and " + division) ;
    }
}
